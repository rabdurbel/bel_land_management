...
from . import  building_info
from . import  property_owner
from . import  land_info
from . import  land_tax
from . import building_structure

from . import  mouza_name
from . import  land_configure
from . import property_room
from . import any_case_pending
from . import land_mutation_info
